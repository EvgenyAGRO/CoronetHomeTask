The following project implements Client & Server infrastructure using Java Netty** that allows multiple clients to retrieve/insert data from/to the server using a specific API. The server supports caching and data persistance to disk.
...
Client communicates with server using STDIN and uses the following protocol:
